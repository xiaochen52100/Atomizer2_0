...
import com.example.atomizer2_0.utils.DensityUtil;
...
public class WaveView extends View {
    ...
    private void init(Context context, AttributeSet attrs){
        if (attrs != null){
            ...
            int aP = typedArray.getInteger(R.styleable.WaveView_progressWave, (int) progress);
...
//        Log.i(TAG,"onLayout");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.saveLayer(0, 0, VIEW_WIDTH, VIEW_HEIGHT, null, Canvas.ALL_SAVE_FLAG);
        ...
        ArrayList<Integer> r = new ArrayList<Integer>(pointList.size());
        ...
        if (!isDone) {
            ...
            LinearGradient linearGradient =new LinearGradient(0,0,0,450, Color.BLUE,Color.RED, Shader.TileMode.MIRROR);
